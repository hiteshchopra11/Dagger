...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /* When we declare Car Component at Application level instead of using directly inside our
         * Activity class, we use that instance of carComponent of application in our Activity using
         * the below syntax. This carComponent will live throughout the app.
         */

        carComponent = (application as CarApp).carComponent
